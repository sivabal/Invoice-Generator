...
public class ToDatabase {
	...
	public static void insertInvoiceData(String invoiceNumber, String date, int daysDifference, String billFrom,
			String billTo, Float orderAmount, Float sgst, Float cgst, Integer total) throws Exception {
	 ...
	 * 
	 */
	public static void insertFromAddress(String shopName, String addressLine1, String addressLine2, String city,
			String district, String state, String pincode, String telephone, String mobile, String gstNo)
			throws Exception {
	 ...
	 * 
	 */
	public static void updateFromAddress(String oldShopName, String newShopName, String addressLine1,
			String addressLine2, String city, String district, String state, String pincode, String telephone,
			String mobile, String gstNo) throws Exception {
	 ...
	 * 
	 */
	public static void insertToAddress(String shopName, String addressLine1, String addressLine2, String city,
			String district, String state, String pincode, String telephone, String mobile, String gstNo)
			throws Exception {
	 ...
	 * 
	 */
	public static void updateToAddress(String oldShopName, String newShopName, String addressLine1, String addressLine2,
			String city, String district, String state, String pincode, String telephone, String mobile, String gstNo)
			throws Exception {
	...
	public static void addGoodsProduced(String itemName, String date, String lotNo, Float goodsProduced)
			throws Exception {
	...
	public static void insertGoodsProducedTracker(String itemName, String date, String lotNo, Float goodsProduced)
			throws Exception {

		String insertQuery = "INSERT INTO goodsProducedTracker (itemName, date, lotNo, goodsProduced) VALUES(?,?,?,?)";

		PreparedStatement preparedStmt = GetConnection.connection.prepareStatement(insertQuery);
	...
	public static void updateGoodsProducedTracker(Float goodsProduced, String itemName, String date) throws Exception {

		String query = "update goodsProducedTracker set goodsProduced = ? where itemName = ? and date = ?";
		try (PreparedStatement preparedStmt = GetConnection.connection.prepareStatement(query)) {
	...
	public static void addSalesMade(String itemName, String date, String lotNo, String goodsTaken, String salesManName)
			throws Exception {
	...
	public static void updateSalesMade(String itemName, String date, String salesManName, Float goodsSold,
			Float goodsReturn) throws Exception {
